...
def handle_vanishing_bombs(current_fruits, current_frame_bombs, last_frame_bombs, current_time, game_height, max_age_ms = 30):
...
if __name__ == "__main__":
    ...
    bombs_ms_into_future = 140       # How long into the future we want to predict the bomb. Too much could make it skip fruits.
                                    # This affects the dangerzone in the direction the bomb is moving.
    max_age_ms = 100     # Maximum time (ms) to retain a vanished bomb before discarding it (helps with brief misdetections)
    ...
    def track_fruits(self, screen, prev_FPS, time_ms, delta_time):
        ...
        with lock:
            ...
            # Predict future positions for bombs already in current_fruits
            for box, class_id, track_id in current_fruits:
                if class_id == 20:
                    ...
                    if prediction is not None:
                        ...
                        new_bombs.append((new_box, class_id, track_id))
    ...
    # Calibration values:
    game_frame_w_to_danger_zone_radius_ratio = 0.105
